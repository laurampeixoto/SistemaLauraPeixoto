...
public class LmpJDlgUsuarios extends javax.swing.JDialog {
 ...
 private boolean incluir;
    ...
    private void initComponents() {
        ...
        jCboNivel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cliente", "Funcionário", "Gerente", "Administrador" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmpJDlgUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LmpJDlgUsuarios dialog = new LmpJDlgUsuarios(new javax.swing.JFrame(), true);
