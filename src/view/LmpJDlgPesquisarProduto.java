...
public class LmpJDlgPesquisarProduto extends javax.swing.JDialog {
     ...
     */
    public LmpJDlgPesquisarProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmpJDlgPesquisarProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LmpJDlgPesquisarProduto dialog = new LmpJDlgPesquisarProduto(new javax.swing.JFrame(), true);
